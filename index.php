...
if (isset($_POST['searchbox'])) {
	...
	$posts = DB::query('SELECT body FROM posts WHERE body LIKE :body '.$whereclause.'', $paramsarray);
	echo "<pre>";
	print_r($posts);
	echo "</pre>";
}
...
foreach ($followingposts as $post) {
	...
	if (!DB::query('SELECT post_id FROM post_likes WHERE post_id=:postid AND user_id=:userid', array(':postid'=>$post['id'], 
		':userid'=>$userid))) {
